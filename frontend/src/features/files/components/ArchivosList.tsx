                    ...
                    {!isMemoria ? (
                      ...
                      archivo.procesado && archivo.chromaDbIds ? (
                        <button
                          ...
                          style={{ color: '#F59E0B' }}
                        >
                          <svg width="22" height="16" fill="none" stroke="currentColor" viewBox="0 0 34 24">
                            {/* Foco */}
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                            {/* Borrador */}
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M25 5l4 4-7 7-4-4 7-7zM22 12l-2 2h5l4-4" />
                          </svg>
                        </button>
                      ) : (
